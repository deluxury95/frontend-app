...
//     <div className='w-full max-w-sm mx-auto bg-green-700 shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded focus:outline-none ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
